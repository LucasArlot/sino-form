...
var p = (o, e, t) =>
  e in o ? r(o, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : (o[e] = t);
var s = (o, e, t) => p(o, typeof e != 'symbol' ? e + '' : e, t);
class a {
  constructor() {
    s(this, 'popup', null);
    s(this, 'iframe', null);
    s(this, 'isPopupOpen', !1);
    this.init();
  }
  init() {
    (this.createPopupHTML(), this.bindEvents());
  }
  createPopupHTML() {
    var i;
    if (document.getElementById('sino-form-popup')) {
      ((this.popup = document.getElementById('sino-form-popup')),
        (this.iframe = ((i = this.popup) == null ? void 0 : i.querySelector('iframe')) || null));
      return;
    }
    ...
    e.className = 'sino-form-container';
    const t = document.createElement('button');
    ((t.className = 'sino-form-close'),
      (t.innerHTML = '×'),
      t.setAttribute('aria-label', 'Fermer le formulaire'),
  ...
  bindEvents() {
    ...
    const e = this.popup.querySelector('.sino-form-close');
    (e == null || e.addEventListener('click', () => this.close()),
      this.popup.addEventListener('click', (t) => {
        t.target === this.popup && this.close();
      }),
      document.addEventListener('keydown', (t) => {
        t.key === 'Escape' && this.isPopupOpen && this.close();
      }),
      this.iframe &&
        this.iframe.addEventListener('load', () => {
          var t, i;
          (i = (t = this.iframe) == null ? void 0 : t.contentWindow) == null ||
            i.postMessage({ type: 'resize' }, '*');
        }));
  }
  open() {
...
const n = new a();
window.SinoForm = { open: () => n.open(), close: () => n.close(), isOpen: () => n.isOpen() };
