const e = {
  ...
  m = {
    ...
    companyName: '',
    shipperType: '',
    loads: [JSON.parse(JSON.stringify(e))],
    goodsValue: '',
    goodsCurrency: 'USD',
  ...
  i = {
    ...
    pickupCityPostalDescription:
      'Geben Sie Abholstadt und Postleitzahl für eine präzise Abholung an',
  ...
  c = {
    ...
    additionalDetailsDescription:
      'Informe quaisquer requisitos especiais ou informações adicionais',
  ...
  p = {
    ...
    goodsValueDescription:
      'Укажите коммерческую стоимость для таможенного оформления и страхования',
  ...
  g = { en: a, fr: o, de: i, es: n, it: t, nl: r, zh: s, ar: l, pt: c, tr: d, ru: p },
  f = {
    FR: [
...
export { f as D, g as I, m as a, u as b, e as i };
