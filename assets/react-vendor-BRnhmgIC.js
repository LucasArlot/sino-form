...
function kc() {
  ...
  var pt = {
    ...
    K = {};
  function B(f, h, R) {
    ((this.props = f), (this.context = h), (this.refs = K), (this.updater = R || pt));
  }
  ...
  function Ve(f, h, R) {
    var D,
      ...
      H = null;
    if (h != null)
      for (D in (h.ref !== void 0 && (H = h.ref), h.key !== void 0 && (j = '' + h.key), h))
        Ge.call(h, D) && !ke.hasOwnProperty(D) && (F[D] = h[D]);
    ...
    if (f && f.defaultProps) for (D in ((V = f.defaultProps), V)) F[D] === void 0 && (F[D] = V[D]);
    return { $$typeof: O, type: f, key: j, ref: H, props: F, _owner: ge.current };
  }
  function _t(f, h) {
    return { $$typeof: O, type: f.type, key: h, ref: f.ref, props: f.props, _owner: f._owner };
  }
  function vt(f) {
  ...
  function Ze(f, h, R, D, F) {
    ...
    if (H)
      return (
        ...
        pe(F)
          ? ((R = ''),
            f != null && (R = f.replace(ut, '$&/') + '/'),
            Ze(F, h, R, '', function (Re) {
              return Re;
            }))
          : F != null &&
            (vt(F) &&
    ...
    if (((H = 0), (D = D === '' ? '.' : D + ':'), pe(f)))
      ...
      for (f = Y.call(f), V = 0; !(j = f.next()).done; )
        ((j = j.value), (Y = D + Le(j, V++)), (H += Ze(j, h, R, Y, F)));
    else if (j === 'object')
      throw (
        (h = String(f)),
        Error(
  ...
  return (
    ...
    (M.cloneElement = function (f, h, R) {
      ...
      if (h != null) {
        ...
        for (Y in h)
          Ge.call(h, Y) &&
            !ke.hasOwnProperty(Y) &&
            (D[Y] = h[Y] === void 0 && V !== void 0 ? V[Y] : h[Y]);
      }
      ...
      return { $$typeof: O, type: f.type, key: F, ref: j, props: D, _owner: H };
    }),
    ...
    (M.useImperativeHandle = function (f, h, R) {
      return J.current.useImperativeHandle(f, h, R);
    }),
    ...
    (M.useReducer = function (f, h, R) {
      return J.current.useReducer(f, h, R);
    }),
    (M.useRef = function (f) {
    ...
    (M.useSyncExternalStore = function (f, h, R) {
      return J.current.useSyncExternalStore(f, h, R);
    }),
    ...
    Sa ||
      ...
      (function (O) {
        ...
        function dt(S) {
          ...
          if (C !== T) {
            S[0] = C;
            e: for (var f = 0, h = S.length, R = h >>> 1; f < R; ) {
              var D = 2 * (f + 1) - 1,
                F = S[D],
                j = D + 1,
                H = S[j];
        ...
        ((O.unstable_IdlePriority = 5),
          ...
          (O.unstable_runWithPriority = function (S, T) {
            switch (S) {
              case 1:
              case 2:
              case 3:
          ...
          (O.unstable_scheduleCallback = function (S, T, C) {
...
function Pc() {
  ...
  return (O(), (Si.exports = xc()), Si.exports);
}
export { Pc as a, Ec as r };
